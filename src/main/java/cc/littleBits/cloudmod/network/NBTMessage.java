...
public class NBTMessage implements IMessage {
    ...
    public NBTMessage(NBTTagCompound syncData) {
        this.text = syncData.getString("posX") + "," + syncData.getString("posY") + "," + syncData.getString("posZ") + "," + syncData
                .getString("authToken") + "," + syncData.getString("devID") + "," + syncData.getString("ownerID") + "," + syncData
                .getString("owner") + "," + syncData.getString("setTime") + "," + syncData.getBoolean("direction") + "," + syncData
    ...
    public static class Handler implements IMessageHandler<NBTMessage, IMessage> {
        ...
        public IMessage onMessage(NBTMessage message, MessageContext ctx) {
            ...
            TileEntityCloud te = (TileEntityCloud) (MinecraftServer.getServer()
            ...
            if (!te.getAuth().equals(authToken) || !te.getDevID().equals(devID) || te.getDirection() != direction) {
                if (te.getDirection() == false && direction == true) {
                    te.setPower(0);
                }
            ...
            if (authToken.length() != 64) {
                ...
                MinecraftServer.getServer()
                               .worldServerForDimension(te.getDimension())
